...
class ToggleCommentTest < CommandTestCase
  ...
  def test_add_comment_selection_input_line_mode_full_line_selected
    ...
    ENV["TM_SELECTION_OFFSET"] = '0'
    ENV["TM_SELECTION_LENGTH"] = '12'
  ...
  # TODO Add test for removing line comment when selection in middle of line
  
  # TODO Add test for adding line comment when selection spans multiple lines
  # TODO Add test for removing line comment when selection spans multiple lines
